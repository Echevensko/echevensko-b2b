...
export default function EchevenskoB2BLanding() {
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-neutral-600">
                <div className="flex items-center gap-1"><Star className="h-4 w-4" /> 9.8/10 en Atrápalo</div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="mt-2 text-neutral-700">Conoce el tono, la energía y el tipo de herramientas que llevamos a tu organización.</p>
              ...
              <div className="mt-4 text-sm text-neutral-600">
                <p>*Reemplaza <code>VIDEO_ID</code> por el ID del video de YouTube.</p>
              </div>
            </div>
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm text-neutral-700">
                ...
                <li className="flex gap-2"><Check className="h-4 w-4 mt-0.5"/> Contrato, factura y métricas post-evento (opcional).</li>
      ...
      {/* Estructura */}
      <section id="estructura" className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-16">
          <h2 className="text-3xl font-bold">Contenido del espectáculo corporativo</h2>
          <p className="mt-3 text-neutral-700 max-w-3xl">Un unipersonal entretenido y útil en tres actos, con historias, humor y ejercicios prácticos.</p>
      ...
      <section id="paquetes" className="mx-auto max-w-6xl px-4 py-16">
        <div className="flex items-end justify-between flex-wrap gap-4">
          ...
          <Badge>ES/EN · Presencial u Online</Badge>
        </div>
        <div className="mt-8 grid md:grid-cols-3 gap-4">
          {[
            {
        ...
        <Card className="rounded-3xl overflow-hidden">
          <CardContent className="p-8 md:p-10 grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mt-2 text-neutral-700">Solicita una propuesta en 2 minutos. Pensado para gerencias de RR.HH. en empresas medianas y grandes. Respuesta en 24 horas hábiles.</p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            {[
              ...
              {q: "¿Qué requerimientos técnicos hay?", a: "Presencial: proyector/LED, audio con micrófono de solapa o diadema y retorno básico. Online: Zoom/Teams y prueba técnica."},
          ...
          <div className="md:col-span-3">
            ...
            <form className="mt-6 grid grid-cols-1 gap-3" action="FORM_ACTION_URL" method="POST">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button asChild variant="outline" className="rounded-2xl"><a href="mailto:contacto@echevensko.com?subject=Cotizaci%C3%B3n%20charla%20corporativa">O escríbenos por email</a></Button>
          ...
          <div className="md:col-span-2">
            <Card className="rounded-2xl sticky top-24">
              ...
              <CardContent className="text-sm text-neutral-700 space-y-3">
                <p className="flex items-center gap-2"><Mail className="h-4 w-4"/> contacto@echevensko.com</p>
                <p className="flex items-center gap-2"><Phone className="h-4 w-4"/> +56 9 9999 9999</p>
                ...
                <div className="pt-3 border-t">
                  ...
                  <ul className="mt-2 space-y-1">
                    <li className="flex gap-2"><Check className="h-4 w-4 mt-0.5"/> Factura electrónica</li>
