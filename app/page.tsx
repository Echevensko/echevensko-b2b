...
<section className="relative overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    <div
      aria-hidden
      className="absolute inset-0 bg-[url('https://drive.google.com/file/d/1ufW_zwkuoxKzZdvnWhTgt7UkJGzBpBmQ/view=80&w=1600&auto=format&fit=crop')] bg-cover bg-center opacity-10"
    />
  </div>
